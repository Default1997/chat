...
use frontend\models\ManageMessages;
...
class SiteController extends Controller
{
    ...
    {   
        ...
        $form_manage = new ManageForm();
        $manage_messages = new ManageMessages();

        $allMessages = $model->getAllMessages();
    ...
    public function actionSignup()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->signup()) {
            Yii::$app->session->setFlash('success', 'Регистрация прошла успешно, можешь авторизовываться');
            return $this->goHome();
        }
